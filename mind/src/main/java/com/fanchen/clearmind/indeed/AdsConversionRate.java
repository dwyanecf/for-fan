...
public class AdsConversionRate {
	...
	// The people who buy ads on our network don't have enough data about how ads
	// are working for
	// their business. They've asked us to find out which ads produce the most
	// purchases on their website.

	// Our client provided us with a list of user IDs of customers who bought
	// something on a landing page
	...
	// And our ops team provided us with some raw log data from our ad server
	// showing every time a
	...
	// clicked,
	// then return the ad text, that ad's number of clicks, and how many of those ad
	// clicks
