 ...
 * So the total importance value of employee 1 is 5 + 3 + 3 = 11. Note: One
 * employee has at most one direct leader and may have several subordinates. The
 * maximum number of employees won't exceed 2000.
 *
 */
public class EmployeeImportance {
	...
	public int getImportance(List<Employee> employees, int id) {
		...
		while (!q.isEmpty()) {
			Employee e = employeeMap.get(q.poll());
			sum += e.importance;
